...
/obj/item/clothing/head/helmet/wormcult/wormcult_wolf
	name = "Wolf Headdress"
	desc = "A sturdy headdress made out of a wolf's head in primitive fashion."
	icon_state = "wormcult_wolf"
	item_state = "wormcult_wolf"
	worn_state = "wormcult_wolf"
